...
/// <summary>
/// RegisteRequest
/// 注册请求，继承自BaseRequest（请求基类）
/// </summary>
public class RegisteRequest : BaseRequest
{
    #region 成员变量
    /// <summary>
    /// 登录面板
    ...
    {
        actionCode = ActionCode.Registe; //登录的动作
        registePanel = GetComponent<RegistePanel>(); //获取登录面板
    ...
    {
        string data = JsonConvert.SerializeObject(new ActionData(ActionCode.Registe,
    ...
    public override void OnResponse(string data)
    {
        ...
        registePanel.OnRegisteResponse(returnCode); //异步调用登录面板响应事件
    }
    #endregion
}